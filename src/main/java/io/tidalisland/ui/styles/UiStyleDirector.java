...
public final class UiStyleDirector {
  ...
  public static UiStyle makePrimary() {
    return new UiStyleBuilder().bg(Colors.PRIMARY).hoverBg(Colors.PRIMARY_LIGHT)
        .pressedBg(Colors.PRIMARY_DARK).textColor(Colors.TEXT).borderColor(Colors.BORDER)
        .borderWidth(3).cornerRadius(10).padding(4).build();
  }

  /** Creates a panel style. */
  public static UiStyle makePanel() {
    return new UiStyleBuilder().bg(Colors.PANEL).hoverBg(Colors.PANEL).pressedBg(Colors.PANEL)
        .textColor(Colors.TEXT).borderColor(Colors.BORDER).borderWidth(3).cornerRadius(10)
        .padding(4).build();
  }
  ...
  public static UiStyle makeTransparent() {
    return new UiStyleBuilder().bg(new Color(0, 0, 0, 0)).hoverBg(new Color(0, 0, 0, 0))
        .pressedBg(new Color(0, 0, 0, 0)).textColor(Colors.TEXT).borderColor(new Color(0, 0, 0, 0))
        .borderWidth(0).cornerRadius(0).padding(0).build();
  }
